package com.microservicioStock.stockservices.configuration.exceptionHandler;

import com.microservicioStock.stockservices.domain.exception.EmptyFieldException;
import com.microservicioStock.stockservices.domain.exception.FieldLengthExceededException;

import com.microservicioStock.stockservices.adapters.driven.jpa.mysql.exception.ElementNotFoundException;
import com.microservicioStock.stockservices.adapters.driven.jpa.mysql.exception.CategoryAlreadyExistsException;

import com.microservicioStock.stockservices.adapters.driven.jpa.mysql.exception.NoDataFoundException;
import com.microservicioStock.stockservices.configuration.Constants;
