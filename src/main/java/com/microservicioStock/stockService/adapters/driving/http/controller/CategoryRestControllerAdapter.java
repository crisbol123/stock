package com.microservicioStock.stockService.adapters.driving.http.controller;
...
import com.microservicioStock.stockService.adapters.driving.http.mapper.ICategoryRequestMapper;
import com.microservicioStock.stockService.adapters.driving.http.mapper.ICategoryResponseMapper;
...
public class CategoryRestControllerAdapter {
    ...
    public ResponseEntity<CategoryResponse> getCategoryById(@PathVariable Long id) {
        return ResponseEntity.ok(categoryResponseMapper.toCategoryResponse(categoryServicePort.getCategoryById(id).orElse(null)));
    }
